<template>
  <AtlasDialog
    v-model="showDialog"
    eyebrow="INFO"
    :title="t('licenseAgreement.title', 'License Agreement').value"
    max-width="900"
    :persistent="true"
  ...
  >
        ...
        <div class="license-section mb-6">
          ...
          <div class="license-text">
            <p>
              ...
              Terms® (SNOMED CT®) which is used by permission of the SNOMED International. All
              rights reserved. SNOMED CT® was originally created by the College of American
              Pathologists. "SNOMED", "SNOMED CT" and "SNOMED Clinical Terms" are registered
              trademarks of the SNOMED International (<a
            ...
            <p>
              ...
              governed by the conditions of the following SNOMED CT license issued by SNOMED
              International:
            </p>
            <ol>
              <li>
              ...
              <li>
                SNOMED International Affiliates may use
                <strong>SNOMED International SNOMED CT Browser</strong> as part of a "Data
        ...
        <div class="license-section">
          ...
          <div class="license-text">
            <p>
              ...
              and operated by HemOnc.org LLC. Use of the HemOnc Vocabulary is governed by the
              conditions of this License Agreement issued by HemOnc.org LLC:
            </p>
            <ol>
              <li>
                The meaning of the terms "Data Analysis System", "Data Creation System", and
            ...
            <p>
              ...
              to HemOnc.org and this derivative product harmless from and against all claims,
              liability, losses, damages, costs, and expenses, including--but not limited
              to--legal fees
            </p>
            ...
            <p>
              Data Creation System: a computer system that is used to create records or other data
              that is encoded using HemOnc, for the purposes of facilitating patient care
            </p>
            <p>
              License: the separate
              <a
    ...
    <template #actions>
      <AtlasButton
        ...
        @click="handleReject"
      >
        {{ t('licenseAgreement.reject', 'Reject') }}
      </AtlasButton>
      <AtlasButton
        @click="handleAccept"
      >
        {{ t('licenseAgreement.accept', 'Accept') }}
      </AtlasButton>
    </template>
  </AtlasDialog>
</template>
