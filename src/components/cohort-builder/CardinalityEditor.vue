      ...
      <AtlasRow dense>
        ...
        >
          <AtlasSelect
            ...
            :aria-label="tv('components.cardinalityInput.typeAriaLabel', 'Cardinality Type')"
            variant="outlined"
            hide-details="auto"
        ...
        >
          ...
          >
            ...
            <input
              ...
              :value="count"
              type="number"
              :aria-label="tv('columns.count', 'Count')"
              min="0"
        ...
        >
          <AtlasSelect
            ...
            :aria-label="tv('components.cardinalityInput.countingMethod', 'Counting Method')"
            variant="outlined"
            hide-details="auto"
