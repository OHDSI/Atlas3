...
export async function listPathways(): Promise<ApiResult<Pathway[]>> {
  return unwrap(async () => {
    ...
    throw new ApiError('Invalid pathway list response', 0, null)
  }, CONTEXT)
}
...
export async function getPathway(id: number): Promise<ApiResult<Pathway>> {
  return unwrap(async () => {
    ...
    if (!parsed.success) throw new ApiError('Invalid pathway response', 0, null)
...
export async function createPathway(pathway: Pathway): Promise<ApiResult<Pathway>> {
  return unwrap(async () => {
    ...
    const parsed = PathwaySchema.passthrough().safeParse(data)
    if (!parsed.success) throw new ApiError('Invalid create response', 0, null)
    return parsed.data as Pathway
  }, CONTEXT)
}
...
export async function savePathway(id: number, pathway: Pathway): Promise<ApiResult<Pathway>> {
  return unwrap(async () => {
    ...
    const parsed = PathwaySchema.passthrough().safeParse(data)
    if (!parsed.success) throw new ApiError('Invalid save response', 0, null)
    return parsed.data as Pathway
  }, CONTEXT)
}
...
export async function copyPathway(id: number): Promise<ApiResult<Pathway>> {
  return unwrap(async () => {
    ...
    const parsed = PathwaySchema.passthrough().safeParse(data)
    if (!parsed.success) throw new ApiError('Invalid copy response', 0, null)
    return parsed.data as Pathway
  }, CONTEXT)
}
...
export async function listPathwayExecutions(id: number): Promise<ApiResult<PathwayExecution[]>> {
  return unwrap(async () => {
    ...
    if (!parsed.success) throw new ApiError('Invalid execution list', 0, null)
    return parsed.data
  }, CONTEXT)
}
...
export async function getPathwayExecution(
  ...
  return unwrap(async () => {
    ...
    if (!parsed.success) throw new ApiError('Invalid execution response', 0, null)
    return parsed.data
  }, CONTEXT)
}
...
export async function getPathwayResults(generationId: number): Promise<ApiResult<PathwayResults>> {
  return unwrap(async () => {
    ...
    if (!parsed.success) throw new ApiError('Invalid results response', 0, null)
    return parsed.data
  }, CONTEXT)
}
...
export async function generatePathway(
  ...
  return unwrap(async () => {
    ...
    if (!job.success) throw new ApiError('Invalid generate response', 0, null)
    return {
...
export async function getPathwayDesignByGeneration(
  ...
  return unwrap(async () => {
    ...
    const parsed = PathwaySchema.passthrough().safeParse(data)
    if (!parsed.success) throw new ApiError('Invalid design response', 0, null)
    return parsed.data as Pathway
  }, CONTEXT)
}
