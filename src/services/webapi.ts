...
export async function listCohortSamples(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to list cohort samples for ${cohortDefinitionId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getCohortSample(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `getCohortSample failed for ${cohortDefinitionId}/${sourceKey}/${sampleId}`,
      error
    )
    return null
  }
...
export async function createCohortSample(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `createCohortSample failed for ${cohortDefinitionId}/${sourceKey}`,
      error
    )
...
export async function refreshCohortSample(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `refreshCohortSample failed for ${cohortDefinitionId}/${sourceKey}/${sampleId}`,
      error
    )
    return null
  }
...
export async function deleteCohortSample(
  ...
  try {
    await fetchJSON<unknown>(`/cohortsample/${cohortDefinitionId}/${sourceKey}/${sampleId}`, {
      method: 'DELETE',
    })
    return true
  } catch (error) {
    logger.error(
      'WebAPI',
      `deleteCohortSample failed for ${cohortDefinitionId}/${sourceKey}/${sampleId}`,
      error
    )
    return false
  }
...
export async function getCohortReport(
  ...
  try {
    const data = await fetchJSON<unknown>(`/cohortdefinition/${cohortId}/report/${sourceKey}`)
...
export async function getConditionErasReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch condition eras report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getCohortSpecificReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch cohort specific report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
 ...
 * Endpoint: POST /cohortanalysis
 */
export async function triggerFullAnalysis(cohortId: number, sourceKey: string): Promise<boolean> {
 ...
 * Endpoint: POST /cohortanalysis
 */
export async function triggerQuickAnalysis(cohortId: number, sourceKey: string): Promise<boolean> {
 ...
 * Endpoint: POST /cohortanalysis
 */
export async function triggerUtilization(cohortId: number, sourceKey: string): Promise<boolean> {
...
export async function getPersonsExposureBaselineReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch persons exposure baseline report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getPersonsExposureCohortReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch persons exposure cohort report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getVisitsBaselineReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch visits baseline report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getVisitDatesBaselineReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch visit dates baseline report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getCareSiteVisitDatesBaselineReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch care site visit dates baseline report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getVisitsCohortReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch visits cohort report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getVisitDatesCohortReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch visit dates cohort report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getCareSiteVisitDatesCohortReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch care site visit dates cohort report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getDrugUtilizationBaselineReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch drug utilization baseline report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getDrugUtilizationCohortReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch drug utilization cohort report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getHeraclesHeelReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch Heracles Heel report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getCompletedAnalyses(
  ...
  try {
    const data = await fetchJSON<number[]>(`/cohortresults/${sourceKey}/${cohortId}/analyses`)
    return success(data || [])
  } catch (error) {
    const message =
      error instanceof Error
        ? error.message
        : `Failed to fetch completed analyses for ${cohortId}/${sourceKey}`
...
export async function getConditionsByIndexReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch conditions by index report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getDrugExposureReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch drug exposure report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getDrugsByIndexReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch drugs by index report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getObservationPeriodsReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch observation periods report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getProceduresByIndexReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch procedures by index report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getDataCompletenessReport(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch data completeness report for ${cohortId}/${sourceKey}`,
      error
    )
    return null
  }
...
export async function getCDMDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch CDM drill-down for ${sourceKey}/${domain}/${conceptId}`,
      error
    )
    return null
  }
...
export async function getConditionDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch condition drill-down for ${cohortId}/${sourceKey}/${conditionId}`,
      error
    )
    return null
  }
...
export async function getConditionEraDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch condition era drill-down for ${cohortId}/${sourceKey}/${conditionId}`,
      error
    )
    return null
  }
...
export async function getDrugDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch drug drill-down for ${cohortId}/${sourceKey}/${drugId}`,
      error
    )
    return null
  }
...
export async function getDrugEraDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch drug era drill-down for ${cohortId}/${sourceKey}/${drugId}`,
      error
    )
    return null
  }
...
export async function getMeasurementDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch measurement drill-down for ${cohortId}/${sourceKey}/${conceptId}`,
      error
    )
    return null
  }
...
export async function getObservationDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch observation drill-down for ${cohortId}/${sourceKey}/${conceptId}`,
      error
    )
    return null
  }
...
export async function getProcedureDrilldown(
  ...
  try {
    ...
    logger.error(
      'WebAPI',
      `Failed to fetch procedure drill-down for ${cohortId}/${sourceKey}/${procedureId}`,
      error
    )
    return null
  }
