/**
 * CareSiteVisitDatesBaselineReport Component Tests
 */
...
import CareSiteVisitDatesBaselineReport from '@/components/reports/report-types/CareSiteVisitDatesBaselineReport.vue'
...
function mountComponent(props = {}) {
  return mount(CareSiteVisitDatesBaselineReport, {
    props: {
      cohortId: 1,
...
describe('CareSiteVisitDatesBaselineReport', () => {
  beforeEach(() => {
