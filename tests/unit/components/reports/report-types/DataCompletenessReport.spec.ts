/**
 * DataCompletenessReport Component Tests
 */
...
import DataCompletenessReport from '@/components/reports/report-types/DataCompletenessReport.vue'
...
function mountComponent(props = {}) {
  return mount(DataCompletenessReport, {
    props: {
      cohortId: 1,
...
describe('DataCompletenessReport', () => {
  beforeEach(() => {
  ...
  it('should render title', () => {
    const wrapper = mountComponent()
    expect(wrapper.text()).toContain('Data Completeness')
  })
