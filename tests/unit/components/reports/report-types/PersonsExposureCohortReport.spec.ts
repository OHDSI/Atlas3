/**
 * PersonsExposureCohortReport Component Tests
 */
...
import PersonsExposureCohortReport from '@/components/reports/report-types/PersonsExposureCohortReport.vue'
...
function mountComponent(props = {}) {
  return mount(PersonsExposureCohortReport, {
    props: {
      cohortId: 1,
...
describe('PersonsExposureCohortReport', () => {
  beforeEach(() => {
