/**
 * VisitDatesCohortReport Component Tests
 */
...
import VisitDatesCohortReport from '@/components/reports/report-types/VisitDatesCohortReport.vue'
...
function mountComponent(props = {}) {
  return mount(VisitDatesCohortReport, {
    props: {
      cohortId: 1,
...
describe('VisitDatesCohortReport', () => {
  beforeEach(() => {
