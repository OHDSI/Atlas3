/**
 * DrugExposureReport Component Tests
 */
...
import DrugExposureReport from '@/components/reports/report-types/DrugExposureReport.vue'
...
function mountComponent(props = {}) {
  return mount(DrugExposureReport, {
    props: {
      cohortId: 1,
