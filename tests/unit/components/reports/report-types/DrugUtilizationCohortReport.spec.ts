/**
 * DrugUtilizationCohortReport Component Tests
 */
...
import DrugUtilizationCohortReport from '@/components/reports/report-types/DrugUtilizationCohortReport.vue'
...
function mountComponent(props = {}) {
  return mount(DrugUtilizationCohortReport, {
    props: {
      cohortId: 1,
...
describe('DrugUtilizationCohortReport', () => {
  beforeEach(() => {
