/**
 * DrugsByIndexReport Component Tests
 */
...
import DrugsByIndexReport from '@/components/reports/report-types/DrugsByIndexReport.vue'
...
function mountComponent(props = {}) {
  return mount(DrugsByIndexReport, {
    props: {
      cohortId: 1,
