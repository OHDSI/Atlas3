/**
 * ConditionsByIndexReport Component Tests
 */
...
import ConditionsByIndexReport from '@/components/reports/report-types/ConditionsByIndexReport.vue'
...
function mountComponent(props = {}) {
  return mount(ConditionsByIndexReport, {
    props: {
      cohortId: 1,
...
describe('ConditionsByIndexReport', () => {
  beforeEach(() => {
