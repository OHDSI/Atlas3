/**
 * VisitsBaselineReport Component Tests
 */
...
import VisitsBaselineReport from '@/components/reports/report-types/VisitsBaselineReport.vue'
...
function mountComponent(props = {}) {
  return mount(VisitsBaselineReport, {
    props: {
      cohortId: 1,
