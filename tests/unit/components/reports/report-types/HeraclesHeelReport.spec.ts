/**
 * HeraclesHeelReport Component Tests
 */
...
import HeraclesHeelReport from '@/components/reports/report-types/HeraclesHeelReport.vue'
...
function mountComponent(props = {}) {
  return mount(HeraclesHeelReport, {
    props: {
      cohortId: 1,
