/**
 * PersonsExposureBaselineReport Component Tests
 */
...
import PersonsExposureBaselineReport from '@/components/reports/report-types/PersonsExposureBaselineReport.vue'
...
function mountComponent(props = {}) {
  return mount(PersonsExposureBaselineReport, {
    props: {
      cohortId: 1,
...
describe('PersonsExposureBaselineReport', () => {
  beforeEach(() => {
