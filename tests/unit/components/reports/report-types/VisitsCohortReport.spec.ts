/**
 * VisitsCohortReport Component Tests
 */
...
import VisitsCohortReport from '@/components/reports/report-types/VisitsCohortReport.vue'
...
function mountComponent(props = {}) {
  return mount(VisitsCohortReport, {
    props: {
      cohortId: 1,
