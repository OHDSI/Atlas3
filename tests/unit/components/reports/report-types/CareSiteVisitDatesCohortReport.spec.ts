/**
 * CareSiteVisitDatesCohortReport Component Tests
 */
...
import CareSiteVisitDatesCohortReport from '@/components/reports/report-types/CareSiteVisitDatesCohortReport.vue'
...
function mountComponent(props = {}) {
  return mount(CareSiteVisitDatesCohortReport, {
    props: {
      cohortId: 1,
...
describe('CareSiteVisitDatesCohortReport', () => {
  beforeEach(() => {
