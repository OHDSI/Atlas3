/**
 * VisitDatesBaselineReport Component Tests
 */
...
import VisitDatesBaselineReport from '@/components/reports/report-types/VisitDatesBaselineReport.vue'
...
function mountComponent(props = {}) {
  return mount(VisitDatesBaselineReport, {
    props: {
      cohortId: 1,
...
describe('VisitDatesBaselineReport', () => {
  beforeEach(() => {
