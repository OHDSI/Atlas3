/**
 * ProceduresByIndexReport Component Tests
 */
...
import ProceduresByIndexReport from '@/components/reports/report-types/ProceduresByIndexReport.vue'
...
function mountComponent(props = {}) {
  return mount(ProceduresByIndexReport, {
    props: {
      cohortId: 1,
...
describe('ProceduresByIndexReport', () => {
  beforeEach(() => {
