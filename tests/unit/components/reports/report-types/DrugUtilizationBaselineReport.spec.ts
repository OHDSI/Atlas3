/**
 * DrugUtilizationBaselineReport Component Tests
 */
...
import DrugUtilizationBaselineReport from '@/components/reports/report-types/DrugUtilizationBaselineReport.vue'
...
function mountComponent(props = {}) {
  return mount(DrugUtilizationBaselineReport, {
    props: {
      cohortId: 1,
...
describe('DrugUtilizationBaselineReport', () => {
  beforeEach(() => {
