/**
 * ConditionReport Component Tests
 */
...
import ConditionReport from '@/components/reports/report-types/ConditionReport.vue'
...
describe('ConditionReport', () => {
  ...
  it('should render title with medical icon', () => {
    const wrapper = mountComponent()
