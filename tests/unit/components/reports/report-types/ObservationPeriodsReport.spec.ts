/**
 * ObservationPeriodsReport Component Tests
 */
...
import ObservationPeriodsReport from '@/components/reports/report-types/ObservationPeriodsReport.vue'
...
function mountComponent(props = {}) {
  return mount(ObservationPeriodsReport, {
    props: {
      cohortId: 1,
...
describe('ObservationPeriodsReport', () => {
  beforeEach(() => {
